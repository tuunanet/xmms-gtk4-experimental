...
| `e01s02` | `.github/workflows/ci.yml`, `CONTRIBUTING.md`, `docs/architecture/build-and-test.md` | `tests/test-package-recipes.sh` | `specs/verifications/e01s02-verify.yaml` | Covered locally; live CI pending PR |

## Adversarial refutation

Attempted refutation: the Ubuntu 24.04 analyzer could reject a baseline generated with the newer local analyzer, leaving the CI story unimplemented in practice.
...
No missing story, implementation path, test, or persisted verification evidence was found in the manual fallback. Live GitHub-hosted execution remains a required PR check before merge.
