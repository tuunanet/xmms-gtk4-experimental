# Prior fork changelog

> Historical archive: this file preserves release planning from the XMMS Classic
> stage. It is not the current changelog. See [`../../CHANGELOG.md`](../../CHANGELOG.md).

All notable changes to that stage of the fork were documented in this file.
